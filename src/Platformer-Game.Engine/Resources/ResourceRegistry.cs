...
{
    /// <summary>
    /// Flyweight pool of resources. You create the resources at the beginning and actors access by querying either 
    ...
    public class ResourceRegistry : IDisposable
    {
        ...
        public ResourceRegistry(string assetDirectory)
        {
